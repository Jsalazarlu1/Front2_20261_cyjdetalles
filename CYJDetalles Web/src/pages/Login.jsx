      ...
      {showRegister && (
        <div className="w-full max-w-md p-8 bg-[#D4C5E6] rounded-2xl shadow-lg text-center mb-5">
          ...
          <form onSubmit={handleRegister} className="text-left">
            <div className="mb-5">
              <label className="block mb-2 font-bold text-[#9966D4]"><i className="fas fa-signature"></i> Nombre Completo:</label>
              <input
                type="text"
                value={regNombre}
            ...
            <div className="mb-5">
              <label className="block mb-2 font-bold text-[#9966D4]"><i className="fas fa-id-card"></i> Cédula:</label>
              <input
                type="text"
                value={regDocumento}
